...
addpath( fullfile( cml_home, 'mat'), ...
    ...
    fullfile( cml_home, 'module', 'chan_code', 'ldpc', 'decoder', 'mex', cputype), ...
    fullfile( cml_home, 'util', 'fp'),...
    fullfile( cml_home, 'util', 'scencr'),...
    fullfile( cml_home, 'util', 'tests'),...
    fullfile( cml_home, 'mat', 'plot'));
